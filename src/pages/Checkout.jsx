...
import watch from '../img/watch1.avif'
                    ...
                    <div className="row">
                        <div className="col-7">
                            <div className="checkout-left-data">
                                ...
                                <p className="user-details">Arjun Kumar (arjundevops@gmail.com)</p>
                                ...
                                <form action="" className="d-flex flex-wrap gap-15 justify-content-between">
                                    ...
                                    <div className="w-100">
                                        <div className="d-flex justify-content-between align-items-center">
                                            ...
                                            <i class="fa-solid fa-arrow-left me-2"></i> Return to Cart</Link>
                        ...
                        <div className="col-5">
                            <div className='border-bottom py-4'>
                               ...
                               <div className='w-25 position-relative'>
                                <span style={{top:"-10px" , right:"-4px"}} className="badge bg-secondary text-white rounded-circle p-2 position-absolute">1</span>
                                ...
                                <div>
                                    ...
                                    <p className='total-price'>S / hfgfh</p>
                                </div>
                               </div>
                                <div className='flex-grow-1'>
