            ...
            <header className="header-top-strip py-3">
                <div className="container-xxl">
                    <div className="row">
                        ...
                        <div className="col-6">
                            <p className='text-end text-white mb-0'>Hotline: <a className='text-white' href="tel:+91 8714251877">+91 8714251877</a></p>
                        </div>
                    </div>
                </div>
            </header>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-5">
                            <div className="header-upper-links d-flex align-items-center justify-content-between">
                                ...
                                <FiRefreshCcw className='fs-35' style={{fontSize: "35px"}}/>
            
                                    <p className='mb-0'>Compare <br /> Products</p>
                                </Link></div>
                                <div><Link to='/wishlist' className='d-flex align-items-center gap-10 text-white'>
                                <i className="icon fa-sharp fa-regular fa-heart"></i>
                                    <p className='mb-0'>
                            ...
                            <div className="menu-bottom d-flex align-items-center gap-30 ">
                                <div>
                                    ...
                                    <div className="dropdown">
                                        <button className="btn btn-secondary dropdown-toggle border-0 gap-15 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i className="icon-menu fa-solid fa-bars"></i> <span className="me-5 d-inline-block">Shop Categoriees</span>
                                        </button>
